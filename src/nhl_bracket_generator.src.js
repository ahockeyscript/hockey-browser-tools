      ...
      $.each(conference, function(divisionName, division) {
        ...
        $.each(division, function(index, bracket) {
          ...
          $.each(bracket, function(key, value) {
            ...
            $bracketSlotContent.attr('title', bracket[key].team.name );
            ...
            $bracketSlotContent.click(function() {
              ...
              $round2Content.click(function() {
                ...
                $round3Content.click(function() {
                  var $round4Content = $($(this).clone(true).off());
                  $('.bracket-slot.round-4.' + $(this).data('conference'), $section).empty().append( $round4Content);
                  $round4Content.click( function() { 
                    $(this).css( { margin: '10%' } );
                    $('.champion-logo-container', $section).empty().append( $(this).clone() ); 
                  });
                });
              });
            });
